...
public class GameController {
	...
	void init() {
		...
		machines.add(new Machine_0549(0));
		machines.add(new Machine_0549(1));
		machines.add(new Machine_0549(2));
		machines.add(new Machine_0549(3));
		machines.add(new Machine_0549(4));
		machines.add(new Machine_0549(5));
		machines.add(new Machine_0549(6));
